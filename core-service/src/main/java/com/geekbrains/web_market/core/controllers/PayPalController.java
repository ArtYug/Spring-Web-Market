...
import com.geekbrains.web_market.core.services.PayPalService;
...
public class PayPalController {
    ...
    public ResponseEntity<?> captureOrder(@PathVariable String payPalId) throws IOException {
        ...
        if ("COMPLETED".equals(payPalOrder.status())) {
            ...
            // Optional<com.geekbrains.web_market.core.entities.Order> orderOptional = orderService.findById(orderId);
